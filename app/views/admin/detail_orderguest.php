            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Detail Order Guest</h3>

                    </div>
                    <div class="col-md-7 align-self-center">
                        <a href="?controller=orderguest&action=index"
                ...
                <div class="col-lg-12 d-flex align-items-stretch">
                        <div class="card w-100">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h5 class="card-title">Detail Order Guest</h5>
                                    </div>
                                    <div class="ms-auto">
                                ...
                                <div>
                                <a href="#" class="ms-5 btn waves-effect waves-light btn btn-danger pull-right text-white" onclick="cancelOrderGuest(<?php echo $orderByID['order_id']; ?>)"> Cancel </a>
                                <a href="#" class="btn waves-effect waves-light btn btn-info pull-right text-white" onclick="confirmOrderGuest(<?php echo $orderByID['order_id']; ?>)"> Confirm </a>
